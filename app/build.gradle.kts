...
val agentForceScreenshot = resolveConfigValue("false", "AGENT_FORCE_SCREENSHOT", "agentForceScreenshot").toBoolean()
...
android {
    ...
    defaultConfig {
        ...
        buildConfigField("boolean", "AGENT_FORCE_SCREENSHOT", agentForceScreenshot.toString())
